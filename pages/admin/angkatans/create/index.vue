          ...
          <div class="col-md-12">
            <div class="card border-0 rounded shadow-sm border-top-blue">
              <div class="card-header">
                <span class="font-weight-bold"><i class="fa fa-folder"></i> Tambah Angkatan Baru</span>
              </div>
              <div class="card-body">

                <form @submit.prevent="storeAngkatan">
                  ...
                  <div class="form-group">
                    <label>Alias</label>
                    <input type="text" v-model="angkatan.alias" placeholder="Masukkan Nama Alias" class="form-control">
                    <div v-if="validation.alias" class="mt-2">
                      <b-alert show variant="danger">{{ validation.alias[0] }}</b-alert>
                    </div>
                  </div>
  ...
  export default {
    ...
    methods: {
      ...
      async storeAngkatan() {
        ...
        //sending data to action "storeAngkatan" vuex
        await this.$store.dispatch('admin/angkatan/storeAngkatan', formData)
