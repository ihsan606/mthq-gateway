...
export const actions= {
    ...
    getInvoicesData({commit,state},payload){
        ...
        return new Promise((resolve, reject) =>{
            ...
            this.$axios.get(`/api/admin/invoice?q=${search}&page=${state.page}`)
    ...
    storeInvoice({dispatch, commit},payload){

        //set promises
        return new Promise((resolve, reject) =>{

            this.$axios.post('/api/admin/invoice/',payload)
